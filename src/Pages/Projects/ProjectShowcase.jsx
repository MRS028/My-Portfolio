...
const ProjectShowcase = () => {
  ...
  const projects = [
    {
      ...
      github: "https://github.com/MRS028/Quiz-App",
      description:
        "A full-stack interactive quiz platform offering engaging quizzes, score tracking, and learning insights.",
      techStack: [
        "React",
        "TypeScript",
        "Redux Toolkit",
      ...
      detailedDescription:
        "QuizMind is a comprehensive quiz application that lets users explore quizzes on multiple topics, test their knowledge, and track their progress in real-time. Built with a modern tech stack, it offers a smooth, responsive UI and a scalable backend. Future plans include admin quiz management tools and enhanced content features.",
      features: [
    ...
    },
    {
      ...
      github:
        "https://github.com/MRS028/Medical-Camp-Management-System-Client-Side",
      description:
        "A MERN stack application for managing medical camps with participant registration and organizer tools.",
      techStack: [
        "React",
        "Firebase",
        "CSS",
      ...
      detailedDescription:
        "MCMS offers a seamless way to manage medical camps, ensuring smooth registration, participant tracking, and efficient camp coordination. The platform provides analytics, user management, and an intuitive UI for both organizers and participants.",
      features: [
    ...
    },
    {
      ...
      description:
        "A platform for gamers to explore, share, and discover game reviews with community engagement.",
      techStack: [
        "React",
        "Firebase",
        "CSS",
      ...
      detailedDescription:
        "This project involved working with Firebase for the backend, which required dealing with authentication and real-time data. The biggest challenge was handling the large volume of user-generated content efficiently.",
      features: [
    ...
    },
    {
      ...
      description:
        "A feature-rich, user-centric car rental platform allowing users to book cars, manage profiles, and check availability.",
      techStack: [
        "React",
        "Node.js",
        "Express",
    ...
    },
    {
      ...
      description:
        "A platform for users to get discounts and explore ongoing sales across multiple categories.",
    ...
    },
    {
      ...
      description:
        "A product showcase website featuring mobile phones, laptops, and other gadgets with cart functionality.",
      techStack: ["React", "Tailwind", "Firebase", "Daisyi"],
      detailedDescription:
    ...
    },
    {
      ...
      description:
        "A dynamic news portal where users can explore news articles by category.",
  ...
  return (
    <section
      id="project"
      className="relative py-5 px-4 sm:px-6 lg:px-8 bg-gray-900 overflow-hidden"
    >
      {/* <Element id="project"></Element> */}
      <AnimatedBackground />
      {/* Main content wrapper with blur when modal is open */}
      <div
        className={`relative z-10 max-w-7xl mx-auto transition-all duration-300 ${
          isModalVisible ? "blur-md pointer-events-none select-none" : ""
        }`}
      >
        <SectionTitle
          title="My Projects"
              ...
              <div className="p-6">
                ...
                <div className="flex pt-3 flex-wrap gap-2 mb-4">
                  ...
                  {project.techStack.length > 3 && (
                    <span className="px-3 py-1  text-sm font-medium rounded-full bg-gray-600/50 text-gray-200">
                      +{project.techStack.length - 3}
                    </span>
                  )}
                </div>
      ...
      {isModalVisible && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm">
          ...
          {selectedProject && (
            <div
              className="relative w-[95%] max-w-4xl bg-gray-800 border border-gray-700 rounded-xl shadow-2xl shadow-green-500/10 mx-auto mt-6 md:mt-2 mb-4 overflow-y-auto max-h-[77vh] z-[10000]"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                onClick={closeModal}
                className="absolute  md:top-4 right-4 p-2 rounded-full text-gray-400 hover:bg-gray-700/50 hover:text-white transition-colors z-[10001]"
                ...
                <div className="relative mb-6">
                  <img
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.src =
                        "https://placehold.co/800x400/1f2937/FFFFFF?text=Image+Not+Found";
                    }}
                  ...
                  <button
                    ...
                    className="absolute top-1/2 left-2 md:-left-4 transform -translate-y-1/2 p-2 rounded-full bg-white/10 backdrop-blur-sm shadow-md hover:bg-white/20 transition-colors"
                  ...
                  <button
                    ...
                    className="absolute top-1/2 right-2 md:-right-4 transform -translate-y-1/2 p-2 rounded-full bg-white/10 backdrop-blur-sm shadow-md hover:bg-white/20 transition-colors"
                ...
                <div className="flex flex-wrap gap-4 mt-8 border-t border-gray-700 pt-6">
                  {selectedProject.link && (
                    <a
                      ...
                      className="flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 hover:opacity-90 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
                    >
                  ...
                  {selectedProject.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg transition-colors duration-300"
                    >
